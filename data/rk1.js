...
var featuresLayer4 = new L.GeoJSON(bbmp, {
            style: function(feature) {
                return {opacity: 1,
...
var featuresLayer5 = new L.GeoJSON(pd2031, {
            style: function(feature) {
                return {opacity: 1,
                color: 'rgba(255,0,255,1.0)',
                weight: 3,
...
var GoogleStreet =
          L.tileLayer('https://www.google.com/maps/vt?lyrs=m@189&gl=com&x={x}&y={y}&z={z}', {
            attribution: 'Map data &copy;2023 <a href="http://maps.google.com">Google</a> | Terms of Use',
            maxZoom: 21
          })
var GoogleSatellite =
...
var RMP2015 = L.tileLayer('data/geo/{z}/{x}/{y}.png', {
        transparent: true, opacity: 0.5, minZoom: 15, maxZoom: 20, tms: false, attribution: 'SaiKPrajwal'
      }).addTo(map);
var baseMaps = {'GoogleStreet': GoogleStreet,
                'GoogleSatellite': GoogleSatellite,
                'GoogleHybrid': GoogleHybrid,
               'OpenStreetMap': OpenStreetMap};
var overlayMaps = {'RMP2015': RMP2015, 'Villages': featuresLayer1, 'Road': featuresLayer2, 'PlanningDistricts': featuresLayer3, 'BbmpWardMap': featuresLayer4, 'PD2031': featuresLayer5,};
